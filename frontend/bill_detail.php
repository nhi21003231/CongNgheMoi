...
<div class="container">
    <div class="row">
        ...
        ?>
                    ...
                    <td>
                        <strong><?= executeSingleResult('SELECT ten_nguoinhan FROM hoadon WHERE id=' . $id_HD)['ten_nguoinhan'] ?></strong>
                        <p>Địa chỉ:
                            <?= executeSingleResult('SELECT diachinhanhang FROM hoadon WHERE id=' . $id_HD)['diachinhanhang'] ?>
                        </p>
                        <p>Điện thoại:
                            <?= executeSingleResult('SELECT sdt_nguoinhan FROM hoadon WHERE id=' . $id_HD)['sdt_nguoinhan'] ?>
                        </p>
                    </td>
                            ...
                            <table width=100%>
                                ...
                                $tongtien=0;
                                    ...
                                    foreach($listDetailBill as $chitietHD){
                                        ...
                                        $tongtien+=$chitietHD['so_luong']*$detailPro['don_gia'];
                                        ...
                                        <td align=right>'.currency_format($chitietHD['so_luong']*$detailPro['don_gia']).'</td>
                                    </tr>';
                                    }
                                ?>
